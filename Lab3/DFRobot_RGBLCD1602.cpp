...
#define I2C_MASTER_SCL_IO 22    // SCL pin for ESP32
#define I2C_MASTER_SDA_IO 21    // SDA pin for ESP32
#define I2C_MASTER_NUM I2C_NUM_0 // I2C port number
#define I2C_MASTER_FREQ_HZ 100000 // Frequency (100kHz)

void DFRobot_RGBLCD1602::i2c_master_init() {
    i2c_config_t conf;
...
void DFRobot_RGBLCD1602::send(uint8_t *data, uint8_t len) {
    ...
    for (int i = 0; i < len; i++) {
        ...
        ets_delay_us(100);  // Replace with ESP-IDF equivalent of delayMicroseconds
    }
